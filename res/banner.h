static void show_credits()
{
	...
	printf("\n");
        ...
        printf("\n");
        printf(CL_LCY"              **"PACKAGE_NAME""CL_LYL" "PACKAGE_VERSION CL_LCY" by wong-fi-hung@github**\n");
        printf(CL_LYL"              Based Originaly from cpuminer-multi by tpruvot\n");
        printf(CL_N"######################################################################\n\n");
        printf(CL_LCY"  Author  "CL_LYL"           : wong-fi-hung\n");
        printf(CL_LCY"  Telagram"CL_LYL"           : @Aminudin1 (Wong Fi Hung)\n");
        printf(CL_LCY"  Youtube Channel"CL_LYL"    : CHANNEL CRYPTO\n");
        printf(CL_LCY"  Git repo"CL_LYL"           : https:" "/" "/" "github.com" "/" "wong-fi-hung" "/" "termux-miner\n");
        printf(CL_LCY"  Original git repo"CL_LYL"  : https:" "/" "/" "github.com" "/" "tpruvot" "/" "cpuminer-multi\n");
        printf(CL_LCY"  DGB donation addr"CL_LYL"  : DFnEipdeXYkUnvSby8pQ7jr8WJhQ4Rj9is (wong-fi-hung)\n");
