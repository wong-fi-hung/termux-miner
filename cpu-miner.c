...
static void *miner_thread(void *userdata)
{
	...
	while (1) {
		...
		case ALGO_YESCRYPT:
			...
			break;
		case ALGO_YESCRYPTR16:
			rc = scanhash_yescryptR16(thr_id, work.data, work.target, max_nonce, &hashes_done);
			break;
		case ALGO_YESCRYPTR32:
			rc = scanhash_yescryptR32(thr_id, work.data, work.target, max_nonce, &hashes_done);
			break;
		case ALGO_YESPOWER:
